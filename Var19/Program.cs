...
namespace Var19
{
    public class Program
    {
        ...
        {
            string inputPath = Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "Var19", "INPUT.txt").Trim();
            ...
            File.WriteAllText(Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "Var19", "OUTPUT.txt"), result.ToString().Trim());
        }
